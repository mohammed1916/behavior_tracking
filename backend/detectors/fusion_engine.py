"""Fusion engine for combining multiple detector outputs"""
...
class FusionEngine:
    ...
    def __init__(
        ...
        self.mode = mode if isinstance(mode, FusionMode) else FusionMode[mode.upper()]
    ...
    def fuse(self, outputs: Dict[str, DetectorOutput]) -> DetectorOutput:
        ...
        if self.mode == FusionMode.CONSENSUS:
        ...
        elif self.mode == FusionMode.VETO:
            return self._veto(outputs)
        elif self.mode == FusionMode.MAJORITY:
